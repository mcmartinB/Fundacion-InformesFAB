...
type
  TQRExpedienteSegundo = class(TQuickRep)
    ...
    qrlbl59: TQRLabel;
    qrlbl61: TQRLabel;
    procedure qrlbl54Print(sender: TObject; var Value: String);
...
var
  QRExpedienteSegundo: TQRExpedienteSegundo;
...
procedure TQRExpedienteSegundo.LoadData( const AFechaPromocion, AFechaHistorial, ADirector, ASecretario, ATutor: string );
begin
...
procedure TQRExpedienteSegundo.qrlbl54Print(sender: TObject;
  var Value: String);
begin
  //
...
procedure TQRExpedienteSegundo.PonNota(sender: TObject; var Value: String);
begin
...
procedure TQRExpedienteSegundo.qrlbl61Print(sender: TObject;
  var Value: String);
begin
  Value:=  sSecretario;
end;

procedure TQRExpedienteSegundo.qrlbl60Print(sender: TObject;
  var Value: String);
begin
  Value:=  sDirector;
end;

procedure TQRExpedienteSegundo.QRLabelPrint(sender: TObject;
  var Value: String);
begin
  Value:=  sFechaHistorial;
end;

procedure TQRExpedienteSegundo.PonNotaValenciano(sender: TObject;
  var Value: String);
begin
  if DataSet.FieldByname(TQRDBText( sender ).DataField).AsFloat <> -1 then
...
procedure TQRExpedienteSegundo.qrlbl6Print(sender: TObject;
  var Value: String);
begin
  Value:=  sTutor;
end;
