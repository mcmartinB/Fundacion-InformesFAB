...
type
  TQRExpedienteCuarto = class(TQuickRep)
...
var
  QRExpedienteCuarto: TQRExpedienteCuarto;
...
procedure TQRExpedienteCuarto.LoadData( const AFechaPromocion, AFechaHistorial, ADirector, ASecretario, ATutor: string );
begin
...
procedure TQRExpedienteCuarto.qrlblFechaPromESOPrint(sender: TObject;
  var Value: String);
begin
  //
...
procedure TQRExpedienteCuarto.PonNota(sender: TObject; var Value: String);
begin
...
procedure TQRExpedienteCuarto.qrlbl61Print(sender: TObject;
  var Value: String);
begin
  Value:=  sSecretario;
end;

procedure TQRExpedienteCuarto.qrlbl60Print(sender: TObject;
  var Value: String);
begin
  Value:=  sDirector;
end;

procedure TQRExpedienteCuarto.QRLabelPrint(sender: TObject;
  var Value: String);
begin
  Value:=  sFechaHistorial;
end;

procedure TQRExpedienteCuarto.PonNotaValenciano(sender: TObject;
  var Value: String);
begin
  if DataSet.FieldByname(TQRDBText( sender ).DataField).AsFloat <> -1 then
...
procedure TQRExpedienteCuarto.qrlbl6Print(sender: TObject;
  var Value: String);
begin
  Value:=  sTutor;
end;
