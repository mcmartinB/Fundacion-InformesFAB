...
type
  TQRHistorialSexto = class(TQuickRep)
  ...
  private
    sFechaPromocion, sFechaHistorial, sDirector, sSecretario: string;
  public
    procedure LoadData( const AFechaPromocion, AFechaHistorial, ADirector, ASecretario: string );
  end;

var
  QRHistorialSexto: TQRHistorialSexto;
...
procedure TQRHistorialSexto.LoadData( const AFechaPromocion, AFechaHistorial, ADirector, ASecretario: string );
begin
...
procedure TQRHistorialSexto.qrlbl24Print(sender: TObject;
  var Value: String);
begin
  Value:= '';
...
procedure TQRHistorialSexto.qrlbl61Print(sender: TObject;
  var Value: String);
begin
  Value:=  sSecretario;
end;

procedure TQRHistorialSexto.qrlbl60Print(sender: TObject;
  var Value: String);
begin
  Value:=  sDirector;
end;

procedure TQRHistorialSexto.QRLabelPrint(sender: TObject;
  var Value: String);
begin
  Value:=  sFechaHistorial;
end;

procedure TQRHistorialSexto.qrlblFechaPromESOPrint(sender: TObject;
  var Value: String);
begin
  Value:=  sFechaPromocion;
end;

procedure TQRHistorialSexto.PonNotaSpain(sender: TObject;
  var Value: String);
begin
...
procedure TQRHistorialSexto.PonNotaValenciano(sender: TObject;
  var Value: String);
begin
  if DataSet.FieldByname(TQRDBText( sender ).DataField).AsFloat <> -1 then
