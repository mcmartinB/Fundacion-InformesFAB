...
type
  TQRHistorialCuarto = class(TQuickRep)
...
var
  QRHistorialCuarto: TQRHistorialCuarto;
...
procedure TQRHistorialCuarto.qrlbl24Print(sender: TObject;
  var Value: String);
begin
  Value:= '';
...
procedure TQRHistorialCuarto.LoadData( const AFechaPromocion, AFechaHistorial: string );
begin
  sFechaPromocion:= AFechaPromocion;
end;

procedure TQRHistorialCuarto.qrlblFechaPromESOPrint(sender: TObject;
  var Value: String);
begin
  //
...
procedure TQRHistorialCuarto.PonNota(sender: TObject; var Value: String);
begin
...
procedure TQRHistorialCuarto.PonNotaValenciano(sender: TObject;
  var Value: String);
begin
  if DataSet.FieldByname(TQRDBText( sender ).DataField).AsFloat <> -1 then
