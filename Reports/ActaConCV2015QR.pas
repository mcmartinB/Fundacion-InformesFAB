...
type
  TQRActaConCV2015 = class(TQuickRep)
    ...
    procedure qrbndPortadaAfterPrint(Sender: TQRCustomBand;
      BandPrinted: Boolean);
...
procedure TQRActaConCV2015.PrintTitulo(sender: TObject; var Value: String);
begin
 //
end;

procedure TQRActaConCV2015.PrintLocalidad(sender: TObject; var Value: String);
begin
  Value:= 'El Campello, ' + FormatDateTime('dd" de "mmmm" de "yyyy', dFecha )+ '.';
end;

procedure TQRActaConCV2015.PrintClase(sender: TObject; var Value: String);
begin
  Value:= sClase;
end;

procedure TQRActaConCV2015.PrintAnyo(sender: TObject; var Value: String);
begin
  Value:= sAnyo;
end;

procedure TQRActaConCV2015.PrintFecha(sender: TObject; var Value: String);
begin
  Value:= FormatDateTime('dd/mm/yyyy', dFecha );
end;

procedure TQRActaConCV2015.PrintDirector(sender: TObject; var Value: String);
begin
  Value:= sDirector;
end;

procedure TQRActaConCV2015.PrintTutor(sender: TObject; var Value: String);
begin
  Value:= sTutor;
end;


procedure TQRActaConCV2015.qrbndPortadaAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
...
procedure TQRActaConCV2015.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  qrlblDP.Enabled:= ( iTrimestre = 0 );
  qrshpDP.Enabled:= ( iTrimestre = 0 );
  ...
  qrlblEstadisticas9.Enabled:= ( iTrimestre = 0 );
  ...
  qrshpEstadisticas5.Enabled:= ( iTrimestre = 0 );
