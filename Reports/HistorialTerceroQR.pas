...
type
  TQRHistorialTercero = class(TQuickRep)
...
var
  QRHistorialTercero: TQRHistorialTercero;
...
procedure TQRHistorialTercero.qrlbl24Print(sender: TObject;
  var Value: String);
begin
  Value:= '';
...
procedure TQRHistorialTercero.LoadData( const AFechaPromocion, AFechaHistorial: string );
begin
  sFechaPromocion:= AFechaPromocion;
end;

procedure TQRHistorialTercero.qrlblFechaPromESOPrint(sender: TObject;
  var Value: String);
begin
  //
...
procedure TQRHistorialTercero.PonNotaSpain(sender: TObject; var Value: String);
begin
...
procedure TQRHistorialTercero.PonNotaValenciano(sender: TObject;
  var Value: String);
begin
  if DataSet.FieldByname(TQRDBText( sender ).DataField).AsFloat <> -1 then
