...
type
  TQRExpedientePrimero = class(TQuickRep)
...
var
  QRExpedientePrimero: TQRExpedientePrimero;
...
procedure TQRExpedientePrimero.LoadData( const AFechaPromocion, AFechaHistorial, ADirector, ASecretario, ATutor: string );
begin
...
procedure TQRExpedientePrimero.qrlblFechaPromESOPrint(sender: TObject;
  var Value: String);
begin
  //
...
procedure TQRExpedientePrimero.PonNota(sender: TObject; var Value: String);
begin
...
procedure TQRExpedientePrimero.qrlbl61Print(sender: TObject;
  var Value: String);
begin
  Value:=  sSecretario;
end;

procedure TQRExpedientePrimero.qrlbl60Print(sender: TObject;
  var Value: String);
begin
  Value:=  sDirector;
end;

procedure TQRExpedientePrimero.QRLabelPrint(sender: TObject;
  var Value: String);
begin
  Value:=  sFechaHistorial;
end;

procedure TQRExpedientePrimero.PonNotaValenciano(sender: TObject;
  var Value: String);
begin
  if DataSet.FieldByname(TQRDBText( sender ).DataField).AsFloat <> -1 then
...
procedure TQRExpedientePrimero.qrlbl6Print(sender: TObject;
  var Value: String);
begin
  Value:=  sTutor;
end;
